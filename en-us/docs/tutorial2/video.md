...
## 26.2 音声付きの動画に対応する
音声付きの動画ファイルから `VideoTexture` と `Audio` を同時に作成し、タイミングを合わせて再生することで、音声付きの動画を再生することができます。`Audio` については [チュートリアル 37. オーディオ再生 :material-open-in-new:](../../tutorial3/audio/) で詳しく説明します。プラットフォームによっては、音声付きの動画ファイルの読み込みに対応していない場合があります。
