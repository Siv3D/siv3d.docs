...
## 1. システム要件
### 1.1 開発者システム要件
Windows で OpenSiv3D v0.6.8 プログラミングをするのに必要な開発環境です。
...
### 1.2 アプリ動作システム要件
Windows で OpenSiv3D v0.6.8 を使って開発されたアプリケーションを実行するのに必要な環境です。ゲームやアプリを配布するときの説明書に記載すると良いでしょう。
...
1. **[OpenSiv3D v0.6.8 Installer for Windows Desktop](https://siv3d.jp/downloads/Siv3D/OpenSiv3D_0.6.8_Installer.exe)** をダウンロードして実行します
...
??? summary "SDK を手動インストールする場合の手順"
	...
	1. [OpenSiv3D_SDK_0.6.8.zip](https://siv3d.jp/downloads/Siv3D/manual/0.6.8/OpenSiv3D_SDK_0.6.8.zip) (サイズ: 約 90 MB) をダウンロードして展開し、中身をドキュメントフォルダ（`.../Documents`）に次のように配置します
		- `.../Documents/OpenSiv3D_SDK_0.6.8/addon`
		- `.../Documents/OpenSiv3D_SDK_0.6.8/include`
		- `.../Documents/OpenSiv3D_SDK_0.6.8/lib`
	2. ユーザー環境変数 `SIV3D_0_6_8` を新規作成し、1. で配置した OpenSiv3D SDK のフォルダのパスを設定します
		- 例: `C:/Users/Siv3D/Documents/OpenSiv3D_SDK_0.6.8/include` のように配置した場合、`C:/Users/Siv3D/Documents/OpenSiv3D_SDK_0.6.8` を環境変数 `SIV3D_0_6_8` に設定します
