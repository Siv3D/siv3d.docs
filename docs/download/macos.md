...
Here are the system requirements for OpenSiv3D v0.6.10 programming on macOS.
...
This is the environment required to run applications developed with OpenSiv3D v0.6.10 on macOS. You may want to include it in your instructions when distributing your game or application.
...
1. Download and extract **[OpenSiv3D v0.6.10 Project Templates for macOS](https://siv3d.jp/downloads/Siv3D/siv3d_v0.6.10_macOS.zip)**.
