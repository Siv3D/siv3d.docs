...
Here are the system requirements for OpenSiv3D v0.6.10 programming on Windows.
...
| IDE | Microsoft Visual C++ 2022 17.5<br>(Install "Desktop development with C++" from the Visual Studio Installer) |
...
This is the environment required to run applications developed with OpenSiv3D v0.6.10 on Windows. You may want to include it in your instructions when distributing your game or application.
...
1. Download and run **[OpenSiv3D v0.6.10 Installer for Windows Desktop](https://siv3d.jp/downloads/Siv3D/OpenSiv3D_0.6.10_Installer.exe)**.
