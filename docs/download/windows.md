...
Here are the system requirements for OpenSiv3D v0.6.4 programming on Windows.
...
This is the environment required to run applications developed with OpenSiv3D v0.6.4 on Windows. You may want to include it in your instructions when distributing your game or application.
...
1. Download and run **[OpenSiv3D v0.6.4 Installer for Windows Desktop](https://siv3d.jp/downloads/Siv3D/OpenSiv3D_0.6.4_Installer.exe)**.
...
??? summary "SDK を手動インストールする場合の手順"
	...
	1. Download and extract [OpenSiv3D_SDK_0.6.4.zip](https://siv3d.jp/downloads/Siv3D/manual/0.6.4/OpenSiv3D_SDK_0.6.4.zip) (File size: 88 MB), and place the contents in your documents folder as follows:
		- `.../Documents/OpenSiv3D_SDK_0.6.4/addon`
		- `.../Documents/OpenSiv3D_SDK_0.6.4/include`
		- `.../Documents/OpenSiv3D_SDK_0.6.4/lib`
	2. Create a new environment variable `SIV3D_0_6_4` and set the path to the SDK folder (the parent folder of the `addon/`, `include/`, and `lib/` folders)
