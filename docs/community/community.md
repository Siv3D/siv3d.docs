...
- 開催場所（オンライン）: [Discord Siv3D Server](https://discord.gg/mzevvsY)
- [Dev-day (Jissoukai)](dev-day/)
- 毎月 1～2 回開催

## 3. Lectures
音や画像を使った楽しいプログラミングを体験しながら、ゲームやアプリの開発に役立つ基本的な Siv3D の知識を学ぶイベントです。Siv3D の開発者に直接意見を伝えたり、質問を聞ける機会でもあります。

- [Siv3D Lectures](study-meeting/)

## 4. OpenSiv3D Challenge
