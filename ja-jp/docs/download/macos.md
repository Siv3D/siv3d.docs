...
## 1. システム要件
### 1.1 開発者システム要件
macOS で Siv3D プログラミングをするのに必要な開発環境は次の通りです。
...
### 1.2 アプリ動作システム要件
macOS で Siv3D v0.6.10 を使って開発されたアプリケーションを実行するのに必要な環境は次の通りです。ゲームやアプリを配布するときの説明書に記載すると良いでしょう。
...
1. **[OpenSiv3D v0.6.10 Project Templates for macOS](https://siv3d.jp/downloads/Siv3D/siv3d_v0.6.10_macOS.zip){:target="_blank"}** をダウンロードしてファイルを展開します。
