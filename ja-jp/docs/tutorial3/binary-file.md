# 56. バイナリファイル
データをテキストではなくバイナリ形式でファイルに保存・読み込みする方法を学びます。
...
## 56.6 シリアライズ機能を使って、バイナリファイルに複雑なデータを書き込む
...
## 56.7 シリアライズ機能を使って、バイナリファイルから複雑なデータを読み込む
