...
### 53.16.2 ディレクトリの中身一覧の取得（再帰的な検索なし）
...
### 53.16.3 ディレクトリに含まれる .png ファイル一覧の取得
